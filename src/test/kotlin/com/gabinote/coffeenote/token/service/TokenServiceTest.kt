package com.gabinote.coffeenote.token.service
            ...
            describe("TokenService.generateIdpUri") {
                describe("성공 케이스") {
                    context("올바른 redirectUri와 idpHint가 주어지면,") {
                        val allowedRedirectUri = listOf("https://example.com")
                ...
                describe("실패 케이스") {
                    context("허용되지 않은 redirectUri가 주어지면,") {
                        val allowedRedirectUri = listOf("https://example.com", "https://example.org")
                        val dto = RedirectIdpReqServiceDto(
